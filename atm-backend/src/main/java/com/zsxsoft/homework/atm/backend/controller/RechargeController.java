...
public class RechargeController {
    ...
    @Autowired
    public RechargeController(ATMService atmService, CardRepository cardRepository) {
    ...
    public ResponseEntity<?> recharge(Authentication authentication, @Valid @RequestBody TransactionRequest transactionRequest) {
        ...
        try {
            ...
            t = atmService.recharge(fromCard, transactionRequest);
        ...
        return ResponseEntity.created(location)
                .body(new ApiResponse(true, "Recharged Successfully"));
    }
